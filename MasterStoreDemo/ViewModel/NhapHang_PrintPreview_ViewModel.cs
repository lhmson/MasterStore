...
{
    public class NhapHang_PrintPreview_ViewModel : BaseViewModel
    {
        #region Old code
        ////---------------
        ...
        //public NhapHang_PrintPreview_ViewModel(string MaSo, string TenKH, string Tien, string LTK, string CMND, string DiaChi)
        //{
