...
MaNguoiLap VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES NHANVIEN(MaNguoiDung),
)
GO
...
CREATE TABLE PHIEUDNXUATKHO
(
	MaPhieuDNXK VARCHAR(10) NOT NULL PRIMARY KEY,
	NgayLap SMALLDATETIME NOT NULL,
	MaQuay VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES QUAY(MaQuay),
...
CREATE TABLE CT_PHIEUDNXUATKHO
(
	MaCTPhieuDNXK VARCHAR(10) NOT NULL PRIMARY KEY,
	MaMH VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES MATHANG(MaMH),
	MaPhieuDNXK VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES PHIEUDNXUATKHO(MaPhieUDNXK),
